...
---
## Etapa2
## Agregar primer api: api/articulosfamiliasmock
...
```
  * observe:
    ...
    * la funcion se define como asincrona "async", que aunque no tenga sentido actualmente, la usamos preveyendo cuando obtengamos datos desde la base de datos donde sera necesaria.
